...
export const CPALEAD_ID = "3350009"; // To be filled by user
export const CUSTOM_OFFERWALL_URL = ""; // To be filled by user
export const MONLIX_ID = ""; // To be filled by user

// Ad Networks
export const MONETAG_ZONE_ID = ""; // Monetag Zone ID (e.g., 7654321)
